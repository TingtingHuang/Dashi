...
public interface DBConnection {
	/**
	 * DBConnection (interface) / \ SQLConnection (abstract) NoSQLConnection
	 * (abstract) / \ / \ MySQLConnection PostgreConnection MongoDBConnection
	 * CassadraConnection
	 */

	/**
	 * For this project: DBConnection (interface) / \ MySQLConnection
	 * (implementation) MongoDBConnection (implementation)
	 */
