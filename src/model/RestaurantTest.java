...
public class RestaurantTest {
	...
	public void testRestaurantConstructor() {
		...
		assertEquals(restaurant.getFullAddress(),
				new_restaurant.getFullAddress());
		...
		assertEquals(restaurant.getLongitude(), new_restaurant.getLongitude(),
				0);
